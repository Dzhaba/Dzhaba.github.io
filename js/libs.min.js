...
!(function(e, t) {
	...
	function f(e) {
		return (
			...
			('false' !== e &&
				('null' === e
					? null
					: e === +e + '' ? +e : Le.test(e) ? JSON.parse(e) : e))
		);
	}
	function h(e, t, n) {
		var i;
	...
	function v(e, t, n, i) {
		var o,
			...
			u = (ve.cssNumber[t] || ('px' !== c && +l)) && ze.exec(ve.css(e, t));
		if (u && u[3] !== c) {
			(c = c || u[3]), (n = n || []), (u = +l || 1);
			do {
				(r = r || '.5'), (u /= r), ve.style(e, t, u + c);
			} while (r !== (r = s() / l) && 1 !== r && --a);
		}
		return (
			n &&
		...
		for (var n, i, o = [], r = 0, a = e.length; r < a; r++)
			(i = e[r]),
				i.style &&
					...
					t
						? ('none' === n &&
								((o[r] = _e.get(i, 'display') || null),
								o[r] || (i.style.display = '')),
							'' === i.style.display && Ve(i) && (o[r] = g(i)))
						: 'none' !== n && ((o[r] = 'none'), _e.set(i, 'display', n)));
				...
				if ('object' === ve.type(r)) ve.merge(p, r.nodeType ? [r] : r);
					...
					for (
						a = a || d.appendChild(t.createElement('div')),
							s = (Qe.exec(r) || ['', ''])[1].toLowerCase(),
							l = Ye[s] || Ye._default,
							a.innerHTML = l[1] + ve.htmlPrefilter(r) + l[2],
							u = l[0];
						u--;

					)
						a = a.lastChild;
					ve.merge(p, a.childNodes), (a = d.firstChild), (a.textContent = '');
				} else p.push(t.createTextNode(r));
		for (d.textContent = '', f = 0; (r = p[f++]); )
			if (i && ve.inArray(r, i) > -1) o && o.push(r);
			else if (
				((c = ve.contains(r.ownerDocument, r)),
	...
	function P(e, t) {
		...
		if (1 === t.nodeType) {
			if (
				_e.hasData(e) &&
				((r = _e.access(e)), (a = _e.set(t, r)), (c = r.events))
			) {
				delete a.handle, (a.events = {});
				for (o in c)
					for (n = 0, i = c[o].length; n < i; n++) ve.event.add(t, o, c[o][n]);
			}
			Ie.hasData(e) &&
				((s = Ie.access(e)), (l = ve.extend({}, s)), Ie.set(t, l));
		}
	}
	function O(e, t) {
	...
	function D(e, t, i, o) {
		...
		if (
			...
			for (s = ve.map(y(r, 'script'), A), l = s.length; d < p; d++)
				(c = r),
					d !== f &&
						((c = ve.clone(c, !0, !0)), l && ve.merge(s, y(c, 'script'))),
					i.call(e[d], c, d);
			if (l)
				for (u = s[s.length - 1].ownerDocument, ve.map(s, E), d = 0; d < l; d++)
					(c = s[d]),
						Be.test(c.type || '') &&
							!_e.access(c, 'globalEval') &&
							ve.contains(u, c) &&
							(c.src
								? ve._evalUrl && ve._evalUrl(c.src)
								: n(c.textContent.replace(ot, ''), u));
		}
		return e;
	}
	function M(e, t, n) {
	...
	function L(e, t, n, i, o) {
		...
		for (
			...
			'margin' === n && (a += ve.css(e, n + $e[r], !0, o)),
				i
					? ('content' === n && (a -= ve.css(e, 'padding' + $e[r], !0, o)),
						'margin' !== n &&
							(a -= ve.css(e, 'border' + $e[r] + 'Width', !0, o)))
					: ((a += ve.css(e, 'padding' + $e[r], !0, o)),
						'padding' !== n &&
							(a += ve.css(e, 'border' + $e[r] + 'Width', !0, o)));
		return a;
	}
	function H(e, t, n) {
		...
		return at.test(r)
			? r
			: ((i = a && (fe.boxSizingReliable() || r === e.style[t])),
				'auto' === r && (r = e['offset' + t[0].toUpperCase() + t.slice(1)]),
				(r = parseFloat(r) || 0) +
					L(e, t, n || (a ? 'border' : 'content'), i, o) +
					'px');
	}
			...
			for (i in f)
				l ||
					(g
						...
						: (g = _e.access(e, 'fxshow', { display: c })),
					r && (g.hidden = !v),
					v && m([e], !0),
					p.done(function() {
						v || m([e]), _e.remove(e, 'fxshow');
	...
	function Q(e, t, n) {
		var i,
			...
			u = c.props;
		for (X(u, c.opts.specialEasing); r < a; r++)
			if ((i = Q.prefilters[r].call(c, e, u, c.opts)))
				return (
					ve.isFunction(i.stop) &&
						(ve._queueHooks(c.elem, c.opts.queue).stop = ve.proxy(i.stop, i)),
					i
				);
		return (
			ve.map(u, W, c),
	...
	var we = (function(e) {
		function t(e, t, n, i) {
			...
			if (
				!i &&
				((t ? t.ownerDocument || t : $) !== q && j(t), (t = t || q), _)
			) {
				if (11 !== h && (l = me.exec(e)))
					if ((o = l[1])) {
						if (9 === h) {
						...
						} else if (p && (a = p.getElementById(o)) && F(t, a) && a.id === o)
							return n.push(a), n;
					} else {
		...
		function y(e, t, n, o, r, a) {
			return (
				...
				i(function(i, a, s, l) {
					...
					} else (b = m(b === a ? b.splice(h, b.length) : b)), r ? r(null, a, b, l) : J.apply(a, b);
				})
			);
		}
		function b(e) {
			...
			var o = n.length > 0,
				...
				a = function(i, a, s, l, c) {
					...
					for (
						...
						if (r && u) {
							for (
								d = 0, a || u.ownerDocument === q || (j(u), (s = !_));
								(p = e[d++]);
		...
		try {
			J.apply((U = K.call($.childNodes)), $.childNodes),
		...
		(k = t.support = {}),
			...
			(j = t.setDocument = function(e) {
				...
				return i !== q && 9 === i.nodeType && i.documentElement
					? ((q = i),
						...
						(k.getElementsByClassName = ge.test(q.getElementsByClassName)),
						(k.getById = o(function(e) {
							return (
								(N.appendChild(e).id = z),
								!q.getElementsByName || !q.getElementsByName(z).length
							);
						})),
						k.getById
						...
						(L = []),
						(I = []),
						(k.qsa = ge.test(q.querySelectorAll)) &&
							(o(function(e) {
							...
							? function(e, t) {
									...
									return (
										...
										(!k.sortDetached && t.compareDocumentPosition(e) === n)
											? e === q || (e.ownerDocument === $ && F($, e))
												? -1
												: t === q || (t.ownerDocument === $ && F($, t))
													? 1
													: D ? ee(D, e) - ee(D, t) : 0
											: 4 & n ? -1 : 1)
									);
			...
			(t.attr = function(e, t) {
				...
				var n = C.attrHandle[t.toLowerCase()],
					i = n && Y.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !_) : void 0;
				return void 0 !== i
					? i
					: k.attributes || !_
						? e.getAttribute(t)
			...
			(t.uniqueSort = function(e) {
				var t,
					...
					o = 0;
				if (
					((M = !k.detectDuplicates),
					(D = !k.sortStable && e.slice(0)),
					e.sort(B),
					M)
				) {
			...
			(P = t.select = function(e, t, n, i) {
				...
				if (((n = n || []), 1 === u.length)) {
					if (
						...
						if (!(t = (C.find.ID(a.matches[0].replace(be, we), t) || [])[0]))
							return n;
		...
		if (((n = n || Ae), 'string' == typeof e)) {
			...
			if (i[1]) {
				if (
					...
					ve.merge(
						this,
						ve.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ne, !0),
					),
			...
			function(e, t) {
				ve.fn[e] = function(n, i) {
					...
					return (
						...
						this.length > 1 &&
							(Oe[e] || ve.uniqueSort(o), Pe.test(e) && o.reverse()),
						this.pushStack(o)
					);
				};
			},
	...
	(ve.Callbacks = function(e) {
		e = 'string' == typeof e ? s(e) : ve.extend({}, e);
		var t,
			n,
			i,
			o,
								...
								return function() {
										...
										d = function() {
											...
											if (!(t < a)) {
												...
												(d =
													...
													ve.isFunction(d)
														? o
															? d.call(e, r(a, n, l, o), r(a, n, c, o))
															: (a++,
																d.call(
																	e,
																	r(a, n, l, o),
																	r(a, n, c, o),
																	r(a, n, l, n.notifyWith),
																))
														: (i !== l && ((s = void 0), (u = [e])),
															(o || n.resolveWith)(s, u));
											}
											...
											: function() {
													try {
														...
														ve.Deferred.exceptionHook &&
															ve.Deferred.exceptionHook(e, p.stackTrace),
															t + 1 >= a &&
																(i !== c && ((s = void 0), (u = [e])),
																n.rejectWith(s, u));
													}
									...
									t
										...
										: (ve.Deferred.getStackHook &&
												(p.stackTrace = ve.Deferred.getStackHook()),
											e.setTimeout(p));
								};
							}
							var a = 0;
							return ve
								.Deferred(function(e) {
									n[0][3].add(r(0, e, ve.isFunction(o) ? o : l, e.notifyWith)),
										...
										n[2][3].add(r(0, e, ve.isFunction(i) ? i : c));
								})
								.promise();
						},
						promise: function(e) {
		...
		ve.extend({
			...
			ready: function(e) {
				(!0 === e ? --ve.readyWait : ve.isReady) ||
					((ve.isReady = !0),
					(!0 !== e && --ve.readyWait > 0) || je.resolveWith(ne, [ve]));
			},
		}),
	...
	var qe = function(e, t, n, i, o, r, a) {
			var s = 0,
				l = e.length,
				c = null == n;
			if ('object' === ve.type(n)) {
				o = !0;
				for (s in n) qe(e, t, s, n[s], !0, r, a);
			} else if (
				void 0 !== i &&
				((o = !0),
				ve.isFunction(i) || (a = !0),
				...
				if (void 0 !== i) {
					if (void 0 !== t) {
						Array.isArray(t)
							...
							: ((t = ve.camelCase(t)), (t = t in i ? [t] : t.match(De) || [])),
							(n = t.length);
						for (; n--; ) delete i[t[n]];
					}
		...
		ve.fn.extend({
			data: function(e, t) {
				...
				if (void 0 === e) {
					if (
						this.length &&
						((o = Ie.get(r)), 1 === r.nodeType && !_e.get(r, 'hasDataAttrs'))
					) {
						for (n = a.length; n--; )
							a[n] &&
								((i = a[n].name),
								0 === i.indexOf('data-') &&
									((i = ve.camelCase(i.slice(5))), h(r, i, o[i])));
			...
			queue: function(e, t, n) {
				...
				if (e)
					return (
						...
						n &&
							(!i || Array.isArray(n)
								? (i = _e.access(e, t, ve.makeArray(n)))
								: i.push(n)),
						i || []
					);
			},
			...
			if (g)
				for (
					n.handler && ((r = n), (n = r.handler), (o = r.selector)),
						o && ve.find.matchesSelector(Ge, o),
					...
					if (
						...
						a &&
							...
							((d.teardown && !1 !== d.teardown.call(e, h, g.handle)) ||
								ve.removeEvent(e, f, g.handle),
							delete l[f]);
					} else for (f in l) ve.event.remove(e, f + t[c], n, i, !0);
				ve.isEmptyObject(l) && _e.remove(e, 'handle events');
			}
		},
		dispatch: function(e) {
			var t,
			...
			if (
				...
				for (
					a = ve.event.handlers.call(this, s, c), t = 0;
	...
	ve.extend({
		...
		clone: function(e, t, n) {
			...
			if (
				...
				for (a = y(s), r = y(e), i = 0, o = r.length; i < o; i++) O(r[i], a[i]);
			if (t)
				if (n)
					for (r = r || y(e), a = a || y(s), i = 0, o = r.length; i < o; i++)
						P(r[i], a[i]);
				else P(e, s);
			return (
				(a = y(s, 'script')), a.length > 0 && b(a, !l && y(e, 'script')), s
			);
		},
		...
		ve.each(
			...
			function(e, t) {
				ve.fn[e] = function(e) {
					for (var n, i = [], o = ve(e), r = o.length - 1, a = 0; a <= r; a++)
	...
	ve.extend({
		...
		style: function(e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				return (
					...
					void 0 === n
						? a && 'get' in a && void 0 !== (o = a.get(e, !1, i)) ? o : c[t]
						: ((r = typeof n),
							'string' === r &&
								(o = ze.exec(n)) &&
								o[1] &&
		...
		ve.each(['height', 'width'], function(e, t) {
			ve.cssHooks[t] = {
				get: function(e, n, i) {
					if (n)
						return !lt.test(ve.css(e, 'display')) ||
				...
				set: function(e, n, i) {
					var o,
						...
						a =
							i &&
							L(e, t, i, 'border-box' === ve.css(e, 'boxSizing', !1, r), r);
					return (
						a &&
							(o = ze.exec(n)) &&
							'px' !== (o[3] || 'px') &&
		...
		(ve.cssHooks.marginLeft = q(fe.reliableMarginLeft, function(e, t) {
			if (t)
				return (
		...
		ve.each({ margin: '', padding: '', border: 'Width' }, function(e, t) {
			(ve.cssHooks[e + t] = {
				...
				rt.test(e) || (ve.cssHooks[e + t].set = I);
		}),
		ve.fn.extend({
			css: function(e, t) {
				return qe(
			...
			stop: function(e, t, n) {
				...
				return (
					...
					this.each(function() {
						...
						else for (o in a) a[o] && a[o].stop && mt.test(o) && i(a[o]);
						for (o = r.length; o--; )
							r[o].elem !== this ||
								(null != e && r[o].queue !== e) ||
			...
			propHooks: {
				tabIndex: {
					get: function(e) {
						...
						return t
							? parseInt(t, 10)
							: wt.test(e.nodeName) || (xt.test(e.nodeName) && e.href) ? 0 : -1;
					},
				},
			},
		...
		ve.fn.extend({
			addClass: function(e) {
				...
				if ('string' == typeof e && e)
					for (t = e.match(De) || []; (n = this[l++]); )
						if (((o = Y(n)), (i = 1 === n.nodeType && ' ' + B(o) + ' '))) {
							for (a = 0; (r = t[a++]); )
								i.indexOf(' ' + r + ' ') < 0 && (i += r + ' ');
							(s = B(i)), o !== s && n.setAttribute('class', s);
						}
				return this;
			},
			...
			hasClass: function(e) {
				var t,
					...
					i = 0;
				for (t = ' ' + e + ' '; (n = this[i++]); )
					if (1 === n.nodeType && (' ' + B(Y(n)) + ' ').indexOf(t) > -1)
						return !0;
				return !1;
			},
		});
		...
		ve.extend({
			valHooks: {
				...
				select: {
					...
					set: function(e, t) {
						for (
							var n, i, o = e.options, r = ve.makeArray(t), a = o.length;
							a--;
		...
		trigger: function(t, n, i, o) {
			...
			if (
				...
				if (!o && !d.noBubble && !ve.isWindow(i)) {
					for (
						l = d.delegateType || f, Ct.test(l + f) || (a = a.parentNode);
						a;
						a = a.parentNode
					)
						p.push(a), (s = a);
				...
				for (r = 0; (a = p[r++]) && !t.isPropagationStopped(); )
					(t.type = r > 1 ? l : d.bindType || f),
						(u = (_e.get(a, 'events') || {})[t.type] && _e.get(a, 'handle')),
						u && u.apply(a, n),
						(u = c && a[c]) &&
							u.apply &&
							Ne(a) &&
			...
			ve.each({ focus: 'focusin', blur: 'focusout' }, function(e, t) {
				...
				ve.event.special[t] = {
					...
					teardown: function() {
						...
						o
							? _e.access(i, t, o)
							: (i.removeEventListener(e, n, !0), _e.remove(i, t));
					},
				};
			});
	var Tt = e.location,
		...
		ve.extend({
			...
			ajax: function(t, n) {
					...
					u ||
						...
						c
							? (h.ifModified &&
									...
									x && (ve.lastModified[r] = x),
									(x = C.getResponseHeader('etag')) && (ve.etag[r] = x)),
								204 === t || 'HEAD' === h.type
									? (k = 'nocontent')
									: 304 === t
										? (k = 'notmodified')
						...
						(C.status = t),
						(C.statusText = (n || k) + ''),
						c ? m.resolveWith(v, [p, k, C]) : m.rejectWith(v, [C, k, f]),
						C.statusCode(b),
						(b = void 0),
				...
				if (
					...
					return C;
				(d = ve.event && h.global),
					d && 0 == ve.active++ && ve.event.trigger('ajaxStart'),
					...
					h.ifModified &&
						(ve.lastModified[r] &&
							C.setRequestHeader('If-Modified-Since', ve.lastModified[r]),
						ve.etag[r] && C.setRequestHeader('If-None-Match', ve.etag[r])),
	...
	ve.ajaxSetup({
		...
		(ve.fn.load = function(e, t, n) {
			var i,
				...
				s = e.indexOf(' ');
			return (
				s > -1 && ((i = B(e.slice(s))), (e = e.slice(0, s))),
				ve.isFunction(t)
					? ((n = t), (t = void 0))
		...
		ve.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function(
			e,
			t,
		) {
			var n = 'pageYOffset' === t;
		...
		ve.each(['top', 'left'], function(e, t) {
			ve.cssHooks[t] = q(fe.pixelPosition, function(e, n) {
				if (n)
					return (n = j(e, t)), at.test(n) ? ve(e).position()[t] + 'px' : n;
			});
		}),
		ve.each({ Height: 'height', Width: 'width' }, function(e, t) {
			ve.each({ padding: 'inner' + e, content: t, '': 'outer' + e }, function(
				n,
				i,
			) {
						...
						function(t, n, o) {
							...
							return ve.isWindow(t)
								...
								: 9 === t.nodeType
									...
									: void 0 === o ? ve.css(t, n, s) : ve.style(t, n, o, s);
						},
						t,
						a ? o : void 0,
						a,
	...
	return (
		(ve.noConflict = function(t) {
			return (
				e.$ === ve && (e.$ = Bt), t && e.jQuery === ve && (e.jQuery = Qt), ve
			);
		}),
		t || (e.jQuery = e.$ = ve),
		ve
...
'undefined' == typeof jQuery &&
		...
		e.extend(e.easing, {
			...
			easeInOutExpo: function(e) {
				return 0 === e
					...
					: 1 === e
						? 1
						: e < 0.5 ? n(2, 20 * e - 10) / 2 : (2 - n(2, -20 * e + 10)) / 2;
			},
			...
			easeInElastic: function(e) {
				return 0 === e
					? 0
					: 1 === e ? 1 : -n(2, 10 * e - 10) * o((10 * e - 10.75) * c);
			},
			easeOutElastic: function(e) {
				return 0 === e
					? 0
					: 1 === e ? 1 : n(2, -10 * e) * o((10 * e - 0.75) * c) + 1;
			},
			...
			(function(e) {
				...
				return (function(e, t, n, i) {
					...
					function l(e, n, i, o) {
						...
						function f(t) {
							for (var n = 0, o = 1, r = b - 1; o != r && C[o] <= t; ++o)
								n += w;
							var a = n + (t - C[--o]) / (C[o + 1] - C[o]) * w,
								s = c(a, e, i);
							return s >= g ? u(t, a) : 0 == s ? a : p(t, n, n + w);
						}
						function h() {
							(T = !0), (e != n || i != o) && d();
						}
						...
						var C = x ? new Float32Array(b) : new Array(b),
							...
							S = function(t) {
								return (
									...
									e === n && i === o
										? t
										: 0 === t ? 0 : 1 === t ? 1 : l(f(t), n, o)
								);
							};
						S.getControlPoints = function() {
							return [{ x: e, y: n }, { x: i, y: o }];
						};
						var A = 'generateBezier(' + [e, n, i, o] + ')';
						return (
							(S.toString = function() {
								return A;
							}),
						...
						if (e) {
							...
							for (var r = 0; n > r; r++)
								if (b.State.calls[r]) {
									...
									for (
										var m = Math.min((t - f) / c.duration, 1),
											y = 0,
											w = l.length;
										w > y;
										y++
										...
										if (a(T)) {
											...
											c.visibility !== i &&
												'hidden' !== c.visibility &&
												x.setPropertyValue(T, 'visibility', c.visibility);
											for (var E in k)
												if ('element' !== E) {
													var P,
														O = k[E],
														D = v.isString(O.easing)
															? b.Easings[O.easing]
															: O.easing;
													if (1 === m) P = O.endValue;
													else {
														var M = O.endValue - O.startValue;
														if (
															((P = O.startValue + M * D(m, c, M)),
															!h && P === O.currentValue)
														)
															continue;
													}
													if (((O.currentValue = P), 'tween' === E)) g = P;
														...
														if (x.Hooks.registered[E]) {
															var j = x.Hooks.getRoot(E),
																q = a(T).rootPropertyValueCache[j];
														...
														x.Hooks.registered[E] &&
															(a(T).rootPropertyValueCache[j] = x.Normalizations
																.registered[j]
											...
											c.mobileHA &&
												a(T).transformCache.translate3d === i &&
												((a(T).transformCache.translate3d = '(0px, 0px, 0px)'),
												(S = !0)),
												S && x.flushTransformCache(T);
										}
									}
									c.display !== i &&
										'none' !== c.display &&
						...
						for (
							...
							if (
								(t ||
									r.loop ||
									('none' === r.display &&
										x.setPropertyValue(d, 'display', r.display),
									'hidden' === r.visibility &&
										x.setPropertyValue(d, 'visibility', r.visibility)),
								!0 !== r.loop &&
									(p.queue(d)[1] === i ||
								...
								p.each(x.Lists.transforms3D, function(e, t) {
									...
									a(d).transformCache[t] !== i &&
										new RegExp('^\\(' + n + '[^.]').test(o) &&
										((f = !0), delete a(d).transformCache[t]);
								}),
									r.mobileHA &&
										((f = !0), delete a(d).transformCache.translate3d),
							...
							s && !0 !== r.loop && s(o),
								a(d) &&
									!0 === r.loop &&
									!t &&
									(p.each(a(d).tweensContainer, function(e, t) {
										/^rotate/.test(e) &&
						...
						var x = (b.CSS = {
							...
							Hooks: {
								...
								register: function() {
									for (r = 0; r < x.Lists.colors.length; r++) {
										var e =
											'color' === x.Lists.colors[r]
												? '0 0 0 1'
												: '255 255 255 1';
										x.Hooks.templates[x.Lists.colors[r]] = [
									...
									if (f)
										for (t in x.Hooks.templates) {
											...
											'Color' === i[0] &&
												(i.push(i.shift()),
												o.push(o.shift()),
												(x.Hooks.templates[t] = [i.join(' '), o.join(' ')]));
										}
									for (t in x.Hooks.templates) {
										i = (n = x.Hooks.templates[t])[0].split(' ');
										for (var r in i) {
								...
								injectValue: function(e, t, n) {
									...
									if (i) {
										var o,
											...
											a = i[1];
										return (
											(n = x.Hooks.cleanRootPropertyValue(r, n)),
							...
							Names: {
								...
								SVGAttribute: function(e) {
									...
									return (
										(f || (b.State.isAndroid && !b.State.isChrome)) &&
											(t += '|transform'),
							...
							getPropertyValue: function(e, n, o, r) {
								...
								if (x.Hooks.registered[n]) {
									var c = n,
										u = x.Hooks.getRoot(c);
									o === i &&
										(o = x.getPropertyValue(e, x.Names.prefixCheck(u)[0])),
										x.Normalizations.registered[u] &&
											(o = x.Normalizations.registered[u]('extract', e, o)),
										(l = x.Hooks.extractValue(c, o));
								} else if (x.Normalizations.registered[n]) {
									var d, h;
									'transform' !==
										(d = x.Normalizations.registered[n]('name', e)) &&
										((h = s(e, x.Names.prefixCheck(d)[0])),
								...
								return (
									...
									p.each(e, function(e, r) {
										if ((a(r) === i && b.init(r), n === i))
											o === i && (o = b.CSS.getPropertyValue(r, t));
										else {
						...
						var k = function() {
							...
							function o() {
								function e(e) {
												...
												? ((n = e[0]),
													...
													x.RegEx.isHex.test(e[1])
														...
														: ((v.isString(e[1]) &&
																!x.RegEx.isHex.test(e[1])) ||
																v.isArray(e[1])) &&
															((o = t ? e[1] : c(e[1], s.duration)),
															e[2] !== i && (a = e[2])))
												: (n = e),
											t || (o = o || s.easing),
											v.isFunction(n) && (n = n.call(r, T, C)),
											v.isFunction(a) && (a = a.call(r, T, C)),
											[n || 0, o, a]
										);
									}
									function f(e, t) {
									...
									if ('scroll' === E) {
										...
										s.container
											? v.isWrapped(s.container) || v.isNode(s.container)
												? ((s.container = s.container[0] || s.container),
													...
													(k = m + p(r).position()[S.toLowerCase()] + P))
												: (s.container = null)
											: ((m =
													b.State.scrollAnchor[b.State['scrollProperty' + S]]),
												(w =
													b.State.scrollAnchor[
														b.State[
											...
											b.debug &&
												console.log('tweensContainer (scroll): ', l.scroll, r);
									} else if ('reverse' === E) {
										...
										'none' === a(r).opts.display &&
											...
											(s = p.extend({}, a(r).opts, s)),
											(M = p.extend(!0, {}, a(r).tweensContainer));
										for (var O in M)
											if ('element' !== O) {
												var D = M[O].startValue;
												(M[O].startValue = M[O].currentValue = M[O].endValue),
													(M[O].endValue = D),
													v.isEmptyObject(y) || (M[O].easing = s.easing),
													b.debug &&
														console.log(
													...
													if (x.RegEx.isHex.test(o)) {
														for (
															var s = ['Red', 'Green', 'Blue'],
																l = x.Values.hexToRgb(o),
																c = a ? x.Values.hexToRgb(a) : i,
																u = 0;
															u < s.length;
															u++
														) {
										...
										for (var N in g) {
											...
											if (
												a(r).isSVG ||
												'tween' === F ||
												!1 !== x.Names.prefixCheck(F)[1] ||
												x.Normalizations.registered[F] !== i
											) {
												((s.display !== i &&
													null !== s.display &&
													'none' !== s.display) ||
													...
													s._cacheValues && M && M[N]
														? (H === i && (H = M[N].endValue + M[N].unitType),
															(z = a(r).rootPropertyValueCache[F]))
														: x.Hooks.registered[N]
															? H === i
																? ((z = x.getPropertyValue(r, F)),
																	(H = x.getPropertyValue(r, N, z)))
																: (z = x.Hooks.templates[F][1])
															: H === i && (H = x.getPropertyValue(r, N));
												var $,
													V,
													W,
													R = !1;
									...
									l.element &&
										...
										(a(r).isAnimating = !0),
										T === C - 1
											? (b.State.calls.push([q, h, s, null, A.resolver]),
												!1 === b.State.isTicking &&
								...
								var o,
									...
									l = {};
								switch ((a(r) === i && b.init(r),
								parseFloat(s.delay) &&
									!1 !== s.queue &&
									p.queue(r, s.queue, function(e) {
								...
								!1 !== b.mock &&
									...
									!1 === s.queue
										? s.delay ? setTimeout(e, s.delay) : e()
										: p.queue(r, s.queue, function(t, n) {
												return !0 === n
													? (A.promise && A.resolver(h), !0)
							...
							if (
								...
								s &&
									b.Promise &&
									(A.promise = new b.Promise(function(e, t) {
								...
								switch (g) {
																...
																i === o &&
																	...
																	'stop' === g
																		? (a(i) &&
																				a(i).tweensContainer &&
																				!1 !== r &&
																				p.each(a(i).tweensContainer, function(
																					e,
																					t,
																				) {
									...
									default:
										if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
											...
											return (
												A.promise ? A.rejecter(new Error(M)) : console.log(M),
												e()
											);
										}
										E = 'start';
								...
								var N,
									_ = p.extend({}, b.defaults, y);
								if (((_.loop = parseInt(_.loop)), (N = 2 * _.loop - 1), _.loop))
									for (var I = 0; N > I; I++) {
										var L = { delay: _.delay, progress: _.progress };
										I === N - 1 &&
											((L.display = _.display),
											(L.visibility = _.visibility),
											(L.complete = _.complete)),
											k(h, 'reverse', L);
									}
								return e();
							}
								...
								n.addEventListener('visibilitychange', function() {
									n.hidden
										? ((C = function(e) {
											...
											u())
										: (C = t.requestAnimationFrame || h);
								}),
							(e.Velocity = b),
							e !== t &&
								((e.fn.velocity = k), (e.fn.velocity.defaults = b.defaults)),
	...
	(function(e, t, n, i) {
		...
		function S(e) {
			return new (e.options.inputClass || (me ? F : ye ? V : ge ? R : H))(e, A);
		}
		function A(e, t, n) {
		...
		function I(e, t) {
			return _(t[1], t[0], _e) - _(e[1], e[0], _e);
		}
		function L(e, t) {
		...
		function V() {
			(this.evTarget = Be), (this.targetIds = {}), T.apply(this, arguments);
		}
		function W(e, t) {
			var n = b(e.touches),
				i = this.targetIds;
			if (t & (ke | Ce) && 1 === n.length)
			...
			for (o = 0; o < a.length; )
				i[a[o].identifier] && s.push(a[o]),
					t & (Te | Se) && delete i[a[o].identifier],
					o++;
		...
		function Y(e) {
			return e & st
				? 'cancel'
				: e & rt ? 'end' : e & ot ? 'move' : e & it ? 'start' : '';
		}
		function U(e) {
			return e == De
				? 'down'
				: e == Oe ? 'up' : e == Ee ? 'left' : e == Pe ? 'right' : '';
		}
		function G(e, t) {
			var n = t.manager;
			return n ? n.get(e) : e;
		...
		var Ie = { mousedown: ke, mousemove: Ce, mouseup: Te },
			Le = 'mousedown',
		...
		var We = { touchstart: ke, touchmove: Ce, touchend: Te, touchcancel: Se },
			Re = 'touchstart',
		...
		var Qe = { touchstart: ke, touchmove: Ce, touchend: Te, touchcancel: Se },
		...
		(B.prototype = {
			...
			c(Z, B, {
				...
				process: function(e) {
					...
					return i && (n & Se || !o)
						? t | st
						: i || o ? (n & Te ? t | rt : t & it ? t | ot : it) : 32;
				},
			}),
			c(J, Z, {
				defaults: { event: 'pan', threshold: 10, pointers: 1, direction: qe },
				getTouchAction: function() {
					var e = this.options.direction,
						t = [];
					return e & Me && t.push(tt), e & je && t.push(et), t;
				},
			...
			c(ee, B, {
				...
				process: function(e) {
					...
					if (((this._input = e), !i || !n || (e.eventType & (Te | Se) && !r)))
						this.reset();
					...
					else if (e.eventType & Te) return at;
					return 32;
				},
				reset: function() {
			...
			c(ne, Z, {
				...
				attrTest: function(e) {
					...
					return (
						n & (Me | je)
							? (t = e.velocity)
							: n & Me ? (t = e.velocityX) : n & je && (t = e.velocityY),
						this._super.attrTest.call(this, e) &&
							n & e.direction &&
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
	...
	(function(e) {
		(e.fn.collapsible = function(t, n) {
			var i = { accordion: void 0, onOpen: void 0, onClose: void 0 },
				o = t;
			return (
				(t = e.extend(i, t)),
				this.each(function() {
					...
					function a(e, n) {
						n || e.toggleClass('active'),
							t.accordion || 'accordion' === f || void 0 === f ? i(e) : r(e),
							s(e);
					}
					function s(e) {
						e.hasClass('active')
					...
					var d = e(this),
						...
						f = d.data('collapsible');
					if ('destroy' !== o)
						if (n >= 0 && n < p.length) {
							var h = p.eq(n);
							h.length &&
								('open' === o || ('close' === o && h.hasClass('active'))) &&
								a(h);
						} else
							u(),
								d.on('click.collapse', '> li > .collapsible-header', function(
									t,
								) {
									var n = e(t.target);
									l(n) && (n = c(n)), a(n);
								}),
								t.accordion || 'accordion' === f || void 0 === f
									? a(p.filter('.active').first(), !0)
						...
						: void this.each(function() {
								function i() {
									void 0 !== a.data('induration') &&
										...
										void 0 !== a.data('gutter') &&
											(s.gutter = a.data('gutter')),
			...
			return this.each(function() {
				function t() {
					...
					var t = s.parent('.material-placeholder'),
						i = (window.innerWidth, window.innerHeight, s.data('width')),
						l = s.data('height');
					s.velocity('stop', !0),
		...
		e.fn.parallax = function() {
			...
			return this.each(function(n) {
				function i(n) {
					...
					i =
						t < 601
							? o.height() > 0 ? o.height() : o.children('img').height()
					...
					n && r.css('display', 'block'),
						s > c &&
							l < c + u &&
							r.css('transform', 'translate3D(-50%,' + p + 'px, 0)');
				}
				var o = e(this);
				o.addClass('parallax'),
					o
			...
			init: function(t) {
				...
				return this.each(function(n) {
					var o,
						...
						f = u.width(),
						h = e(),
						v = Math.max(f, u[0].scrollWidth) / p.length,
						g = 0,
						m = 0,
						y = !1,
						b = function(e) {
					...
					t.swipeable && d > t.responsiveThreshold && (t.swipeable = !1),
						0 === (o = e(p.filter('[href="' + location.hash + '"]'))).length &&
							(o = e(this)
									...
									onCycleTo: function(e) {
										if (!y) {
											...
											(g = a.index(e)),
												...
												(o = p.eq(g)).addClass('active'),
												x(n),
												'function' == typeof t.onShow && t.onShow.call(u[0], r);
										}
									},
								}))
						...
						u.off('click.tabs').on('click.tabs', 'a', function(n) {
							if (
								...
								(o = e(this)),
									...
									o.addClass('active'),
									(m = g),
									(g = p.index(e(this))) < 0 && (g = 0),
									t.swipeable
										? h.length &&
											h.carousel('set', g, function() {
												'function' == typeof t.onShow && t.onShow.call(u[0], r);
											})
										: (void 0 !== r &&
												(r.show(),
	...
	(function(e) {
		...
		function a(t) {
			...
			null !== n &&
				...
				n.addEventListener('dragend', c.hide, !1));
		}
		var s = s || {},
			...
			c = {
				...
				hide: function(e) {
					...
					var r = (n = i[i.length - 1]).getAttribute('data-x'),
								...
								value: function() {
									...
									if ((t.classList.add('toast'), this.options.className)) {
										var n = this.options.className.split(' '),
											o = void 0,
											r = void 0;
										for (o = 0, r = n.length; o < r; o++) t.classList.add(n[o]);
									}
									return (
								...
								.on('pan', function(n) {
									if ('touch' == n.gesture.pointerType) {
										...
										var i = n.gesture.center.x,
											r = n.gesture.center.y;
										if ((n.gesture.velocityX, 0 === i && 0 === r)) return;
										var s = e('body'),
											c = e('#sidenav-overlay'),
											u = s.innerWidth();
										if (
											...
											i < window.innerWidth - t.menuWidth / 2
												? (l = !0)
												: i >= window.innerWidth - t.menuWidth / 2 && (l = !1);
										...
										'left' === t.edge
											...
											: ((p = Math.abs((i - window.innerWidth) / t.menuWidth)),
												c.velocity(
													{ opacity: p },
													{ duration: 10, queue: !1, easing: 'easeOutQuad' },
												));
		...
		(e.scrollSpy = function(t, i) {
			...
			return (
				...
				t.on('scrollSpy:enter', function() {
					...
					var t = e(this);
					l[0]
						? (e(i.getActiveElement(l[0].attr('id'))).removeClass(
								i.activeClass,
							),
							t.data('scrollSpy:id') < l[0].data('scrollSpy:id')
								? l.unshift(e(this))
								: l.push(e(this)))
						: l.push(e(this)),
		...
		e(document).ready(function() {
			function t(t) {
				...
				i.html(s),
					t.is(':visible')
						? i.css('width', t.width())
						: i.css('width', e(window).width() / 2),
					t.data('original-height') <= i.height()
			...
			i.length ||
				((i = e('<div class="hiddendiv common"></div>')), e('body').append(i)),
			...
			e(document).on('change', o, function(t) {
				...
				n.find('.value').html(e(this).val()), n.hasClass('active') || a(n);
				var i = s(e(this));
						...
						this.each(function() {
							...
							if (e.isEmptyObject(o))
								...
								var u = function(e, t) {
									...
									d = function() {
										(a = -1), c.find('.active').removeClass('active');
									},
									p = function() {
										c.empty(), d(), (n = void 0);
									};
					...
					this.each(function() {
						...
						-1 != u && (o = c.eq(u)),
							s.hasClass('fullscreen') ||
								(t.indicators ? s.height(t.height + 40) : s.height(t.height),
								l.height(t.height)),
							...
							.on('pan', function(e) {
								if ('touch' === e.gesture.pointerType) {
									...
									($curr_slide = l.find('.active')),
										...
										4 === t && (n > s.innerWidth() / 2 || i < -0.65)
											? (f = !0)
											: 2 === t &&
												(n < -1 * s.innerWidth() / 2 || i > 0.65) &&
												(p = !0);
									var r;
									p &&
										(0 === (r = $curr_slide.next()).length && (r = c.first()),
										r.velocity(
											{ opacity: 1 },
											{ duration: 300, queue: !1, easing: 'easeOutQuad' },
										)),
										f &&
											(0 === (r = $curr_slide.prev()).length && (r = c.last()),
											r.velocity(
												{ opacity: 1 },
												{ duration: 300, queue: !1, easing: 'easeOutQuad' },
											));
					...
					e(this)
						...
						.on('panend', function(i) {
							if (
								...
								if (t || n) {
									var r;
									(r = t ? o.innerWidth() : -1 * o.innerWidth()),
										o.velocity(
											{ translateX: r },
											{
												duration: 100,
		...
		Materialize.scrollFire = function(e) {
			var n = function() {
					for (
						...
						null !== s &&
							t > s.getBoundingClientRect().top + window.pageYOffset + r &&
							!0 !== i.done &&
							('function' == typeof a
								? a.call(this, s)
								: 'string' == typeof a && new Function(a)(s),
							(i.done = !0));
					}
				},
		...
		function t(r, s, u, d) {
			function p() {
				return t._.node(
					...
					t._.node(
						...
						t._.node(
							'div',
							t._.node('div', T.component.nodes(b.open), x.box),
							x.wrap,
						),
						x.frame,
					),
			...
			function f() {
				k
					...
					.addClass(x.input)
					.attr('tabindex', -1)
					.val(k.data('value') ? T.get('select', w.format) : r.value),
					w.editable ||
						k
							.on('focus.' + b.id + ' click.' + b.id, function(e) {
						...
						function() {
							...
							(o = o && (o.type || o.href) && o),
								...
								!i && n.nav
									...
									: !i && 'pick' in n
										? (T.set('select', n.pick), w.closeOnSelect && T.close(!0))
										: n.clear
				...
				!0 === w.hiddenName
					...
					(T._hidden = e(
						'<input type=hidden name="' +
							t +
							'"' +
							(k.data('value') || r.value
								? ' value="' + T.get('select', w.formatSubmit) + '"'
								: '') +
							'>',
					)[0]),
					k.on('change.' + b.id, function() {
						T._hidden.value = r.value ? T.get('select', w.formatSubmit) : '';
					}),
					w.container ? e(w.container).append(T._hidden) : k.before(T._hidden);
			}
			function g(e) {
				var t = e.keyCode,
					n = /^(8|46)$/.test(t);
				if (27 == t) return T.close(), !1;
				(32 == t || n || (!b.open && T.component.key[t])) &&
					(e.preventDefault(),
					e.stopPropagation(),
					n ? T.clear().close() : T.open());
			}
			function m(e) {
				e.stopPropagation(),
					'focus' == e.type && T.$root.addClass(x.focused),
					T.open();
			}
			if (!r) return t;
			var y = !1,
				b = { id: r.id || 'P' + Math.abs(~~(Math.random() * new Date())) },
				...
				T = (C.prototype = {
					...
					render: function(e) {
						return (
							e
								? T.$root.html(p())
								: T.$root.find('.' + x.box).html(T.component.nodes(b.open)),
							T.trigger('render')
						);
					},
					stop: function() {
						return b.start
							? (T.close(),
								...
								T.$root.remove(),
								k.removeClass(x.input).removeData(s),
								setTimeout(function() {
									k.off('.' + b.id);
								}, 0),
								(r.type = b.type),
					...
					open: function(n) {
						return b.open
							...
							: (k.addClass(x.active),
								o(r, 'expanded', !0),
								setTimeout(function() {
									T.$root.addClass(x.opened), o(T.$root[0], 'hidden', !1);
								}, 0),
								!1 !== n &&
									((b.open = !0),
									y &&
									...
									T.$root.eq(0).focus(),
									l
										.on('click.' + b.id + ' focusin.' + b.id, function(e) {
											var t = e.target;
											t != r &&
												t != document &&
												3 != e.which &&
												T.close(t === T.$root.children()[0]);
										})
										.on('keydown.' + b.id, function(n) {
											...
											27 == i
												? T.close(!0)
												: r != T.$root[0] || (!o && 13 != i)
													? e.contains(T.$root[0], r) &&
														13 == i &&
														(n.preventDefault(), r.click())
													: (n.preventDefault(),
														o
															? t._.trigger(T.component.key.go, T, [
																	t._.trigger(o),
																])
															: T.$root
																	.find('.' + x.highlighted)
					...
					close: function(e) {
						return (
							...
							b.open
								? ((b.open = !1),
									y && c.css('overflow', '').css('padding-right', '-=' + i()),
									l.off('.' + b.id),
									T.trigger('close'))
								: T
						);
							...
							for (o in s)
								(r = s[o]),
									o in T.component.item &&
										(void 0 === r && (r = null), T.component.set(o, r, i)),
									('select' != o && 'clear' != o) ||
										k
					...
					get: function(e, n) {
						...
						if (e in T.component.item) {
							if ('string' == typeof n) {
								...
								return i
									? t._.trigger(T.component.formats.toString, T.component, [
											n,
											i,
										])
									: '';
			...
			(n.prototype.measure = function(e, t) {
				...
				return (
					t
						? 'string' == typeof t
							? (t = n.parse(e, t))
							: i.isInteger(t) && (t = n.now(e, t, { rel: t }))
						: (t = 'min' == e ? -1 / 0 : 1 / 0),
					t
				);
			}),
					...
					o = n.item.disable.filter(function(o) {
						return i.isInteger(o)
							...
							: t.isArray(o) || i.isDate(o)
								...
								: t.isPlainObject(o) ? n.withinRange(o, e) : void 0;
					});
				return (
					(o =
						o.length &&
			...
			(n.prototype.nodes = function(e) {
				...
				return (
					...
					(createWeekdayLabel = function() {
						var e;
						return (e = null != a ? a.day : r.day), n.weekdaysShort[e];
					}),
					i.node(
						'div',
		...
		function o(o, a) {
			...
			if (
				...
				var _ = u.find('.clockpicker-canvas'),
					I = t('svg');
				I.setAttribute('class', 'clockpicker-svg'),
					I.setAttribute('width', x),
					I.setAttribute('height', x);
				var L = t('g');
				...
				H.setAttribute('class', 'clockpicker-canvas-bearing'),
					...
					H.setAttribute('r', 4);
				var F = t('line');
				F.setAttribute('x1', 0), F.setAttribute('y1', 0);
				var z = t('circle');
				z.setAttribute('class', 'clockpicker-canvas-bg'),
					z.setAttribute('r', w),
					L.appendChild(F),
					L.appendChild(z),
					L.appendChild(H),
			...
			return this.each(function() {
				...
				o.parent().find('span[class="character-counter"]').length ||
					(void 0 !== o.attr('data-length') &&
						(o.on('input', t), o.on('focus', t), o.on('blur', i), n(o)));
			});
		}),
			e(document).ready(function() {
				...
				return this.each(function(n) {
					...
					function s(n) {
						...
						var i,
							...
							d = w;
						if (
							((b = 'number' == typeof n ? n : b),
							(w = Math.floor((b + k / 2) / k)),
							(r = b - w * k),
							(s = r < 0 ? 1 : -1),
							(l = -s * r * 2 / k),
							(o = C >> 1),
							t.fullWidth
								? (u = 'translateX(0)')
								: ((u = 'translateX(' + (F[0].clientWidth - g) / 2 + 'px) '),
									(u += 'translateY(' + (F[0].clientHeight - m) / 2 + 'px)')),
							$)
						) {
							var p = w % C,
								f = I.find('.indicator-item.active');
							f.index() !== p &&
								(f.removeClass('active'),
								I.find('.indicator-item')
									.eq(p)
									.addClass('active'));
						}
						for (
							(!V || (w >= 0 && w < C)) &&
								((c = v[a(w)]),
								e(c).hasClass('active') ||
									(F.find('.carousel-item').removeClass('active'),
									e(c).addClass('active')),
								(c.style[D] =
									u +
									' translateX(' +
						...
						if (
							((!V || (w >= 0 && w < C)) &&
								...
								(c.style.opacity = tweenedOpacity),
								(c.style.display = 'block')),
							d !== w && 'function' == typeof t.onCycleTo)
						) {
							var h = F.find('.carousel-item').eq(a(w));
							t.onCycleTo.call(this, h, N);
						}
						'function' == typeof H && (H.call(this, h, N), (H = null));
					}
					function l() {
						var e, t, n;
						(t = (e = Date.now()) - j),
							...
							(n = b - M),
							(M = b),
							(P = 1e3 * n / (1 + t) * 0.8 + 0.2 * P);
					}
					function c() {
						var e, n;
						A &&
							((e = Date.now() - j),
							(n = A * Math.exp(-e / t.duration)) > 2 || n < -2
								? (s(E - n), requestAnimationFrame(c))
								: s(E));
					}
					function u(n) {
						if (N) return n.preventDefault(), n.stopPropagation(), !1;
						if (!t.fullWidth) {
							var i = e(n.target)
								.closest('.carousel-item')
								.index();
							0 != a(w) - i && (n.preventDefault(), n.stopPropagation()), d(i);
						}
					}
					function d(e) {
						var t = w % C - e;
						V ||
							(t < 0
								? Math.abs(t + C) < Math.abs(t) && (t += C)
								: t > 0 && Math.abs(t - C) < t && (t -= C)),
							t < 0
								? F.trigger('carouselNext', [Math.abs(t)])
								: t > 0 && F.trigger('carouselPrev', [t]);
					}
					function p(t) {
						'mousedown' === t.type &&
							e(t.target).is('img') &&
					...
					function h(e) {
						if (x)
							return (
								...
								clearInterval(q),
								(E = b),
								(P > 10 || P < -10) && (E = b + (A = 0.9 * P)),
								(E = Math.round(E / k) * k),
								V && (E >= k * (C - 1) ? (E = k * (C - 1)) : E < 0 && (E = 0)),
								(A = E - b),
								(j = Date.now()),
					...
					var v,
						...
						N,
						_,
						I = e('<ul class="indicators"></ul>'),
						L = null,
						H = null,
						F = e(this),
						z = F.find('.carousel-item').length > 1,
						$ = (F.attr('data-indicators') || t.indicators) && z,
						V = F.attr('data-no-wrap') || t.noWrap || !z,
						W = F.attr('data-namespace') || i + n;
					F.attr('data-namespace', W);
					var R = function(t) {
						var n = F.find('.carousel-item.active').length
								? F.find('.carousel-item.active').first()
								: F.find('.carousel-item').first(),
							i = n.find('img').first();
						if (i.length)
							if (i[0].complete)
								if (i.height() > 0) F.css('height', i.height());
								else {
					...
					if (
						(t.fullWidth &&
							((t.dist = 0),
							R(),
							$ && F.find('.carousel-fixed-item').addClass('with-indicators')),
						F.hasClass('initialized'))
					)
						return (
							e(window).trigger('resize'), F.trigger('carouselNext', [1e-6]), !0
						);
					F.addClass('initialized'),
						(x = !1),
						(b = E = 0),
						(v = []),
						(g = F.find('.carousel-item')
							.first()
							.innerWidth()),
						(m = F.find('.carousel-item')
							.first()
							.innerHeight()),
						(k = 2 * g + t.padding),
						F.find('.carousel-item').each(function(t) {
							if ((v.push(e(this)[0]), $)) {
						...
						['webkit', 'Moz', 'O', 'ms'].every(function(e) {
							var t = e + 'Transform';
							return void 0 === document.body.style[t] || ((D = t), !1);
						});
					var X = Materialize.throttle(function() {
						t.fullWidth
							? ((g = F.find('.carousel-item')
									.first()
									.innerWidth()),
								F.find('.carousel-item.active').height(),
								(k = 2 * g + t.padding),
								(E = b = 2 * w * g),
								R(!0))
							: s();
					...
					e(window)
						.off('resize.carousel-' + W)
						.on('resize.carousel-' + W, X),
						void 0 !== window.ontouchstart &&
							(F.on('touchstart.carousel', p),
							F.on('touchmove.carousel', f),
							F.on('touchend.carousel', h)),
						F.on('mousedown.carousel', p),
						F.on('mousemove.carousel', f),
						F.on('mouseup.carousel', h),
						F.on('mouseleave.carousel', h),
						F.on('click.carousel', u),
						s(b),
						e(this).on('carouselNext', function(e, t, n) {
							void 0 === t && (t = 1),
								'function' == typeof n && (H = n),
								(E = k * Math.round(b / k) + k * t),
								b !== E &&
									((A = E - b), (j = Date.now()), requestAnimationFrame(c));
						}),
						...
						e(this).on('carouselSet', function(e, t, n) {
							void 0 === t && (t = 0), 'function' == typeof n && (H = n), d(t);
						});
				});
			},
			next: function(t, n) {
					...
					var l = function() {
						...
						c = function() {
							...
							(L.top = b ? T : ''),
								...
								r.css({ top: _, left: I, width: q, height: N });
						};
					'open' == t &&
						(c(),
						o.is('.open') ||
